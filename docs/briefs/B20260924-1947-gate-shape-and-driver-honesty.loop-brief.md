...
- **Every task here adds a scenario, and that moves a number five documents
  ...
  writing the correct values are **40 checks** and **37 scenarios**, T1, T2
  and T3 having already landed the first three of the nine; each task after it
...
touch code paths the existing 37 scenarios already exercise — a plan whose
