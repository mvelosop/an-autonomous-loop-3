...
- **Every task here adds a scenario, and that moves a number five documents
  ...
  writing the correct values are **41 checks** and **38 scenarios**, T1, T2,
  T3 and T4 having already landed the first four of the nine; each task after
  it adds one more of each.
...
touch code paths the existing 38 scenarios already exercise — a plan whose
