...
- **Every task here adds a scenario, and that moves a number five documents
  ...
  writing the correct values are **39 checks** and **36 scenarios**, T1 and T2
  having already landed the first two of the nine; each task after it adds one
  more of each.
...
touch code paths the existing 36 scenarios already exercise — a plan whose
