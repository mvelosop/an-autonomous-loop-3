...
finishes by running its own 40-check suite in your repo to prove the install
...
| tests (`.loop/tests/`, 40 offline checks + the calibration harness) | 3,227 |
...
| `.loop/tests/` | 37 fixture scenarios, free and offline |
