...
finishes by running its own 42-check suite in your repo to prove the install
...
| tests (`.loop/tests/`, 42 offline checks + the calibration harness) | 3,227 |
...
| `.loop/tests/` | 39 fixture scenarios, free and offline |
