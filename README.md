...
finishes by running its own 41-check suite in your repo to prove the install
...
| tests (`.loop/tests/`, 41 offline checks + the calibration harness) | 3,227 |
...
| `.loop/tests/` | 38 fixture scenarios, free and offline |
