...
finishes by running its own 46-check suite in your repo to prove the install
...
| tests (`.loop/tests/`, 46 offline checks + the calibration harness) | 3,227 |
...
| `.loop/tests/` | 43 fixture scenarios, free and offline |
