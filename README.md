...
finishes by running its own 45-check suite in your repo to prove the install
...
| tests (`.loop/tests/`, 45 offline checks + the calibration harness) | 3,227 |
...
| `.loop/tests/` | 42 fixture scenarios, free and offline |
