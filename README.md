...
finishes by running its own 43-check suite in your repo to prove the install
...
| tests (`.loop/tests/`, 43 offline checks + the calibration harness) | 3,227 |
...
| `.loop/tests/` | 40 fixture scenarios, free and offline |
