...
finishes by running its own 39-check suite in your repo to prove the install
...
| tests (`.loop/tests/`, 39 offline checks + the calibration harness) | 3,227 |
...
| `.loop/tests/` | 36 fixture scenarios, free and offline |
