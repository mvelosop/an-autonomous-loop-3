...
finishes by running its own 44-check suite in your repo to prove the install
...
| tests (`.loop/tests/`, 44 offline checks + the calibration harness) | 3,227 |
...
| `.loop/tests/` | 41 fixture scenarios, free and offline |
