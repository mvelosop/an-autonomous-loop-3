...
finishes by running its own 37-check suite in your repo to prove the install
...
| tests (`.loop/tests/`, 37 offline checks + the calibration harness) | 3,227 |
...
agent interprets. Here it is 992 lines of `run.sh`, and the instructions shrink
...
| `.loop/tests/` | 34 fixture scenarios, free and offline |
