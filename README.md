...
finishes by running its own 38-check suite in your repo to prove the install
...
| tests (`.loop/tests/`, 38 offline checks + the calibration harness) | 3,227 |
...
| `.loop/tests/` | 35 fixture scenarios, free and offline |
