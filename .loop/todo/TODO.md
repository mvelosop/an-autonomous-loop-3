...
| --- | --- | --- |
| [TD20260924-1720-gate-scope-and-regression-accounting](TD20260924-1720-gate-scope-and-regression-accounting.todo.md) | `exploring-claude`, SPA-220 run | The `B20260924-1714` architect act, which decides which parts earn a loop-brief |
...
`docs/todo.md` still holds **twelve** top-level entries written before this structure existed. They
...
entries should be migrated when each is next touched, not in one sweep that re-reads twelve parked
decisions at once.
